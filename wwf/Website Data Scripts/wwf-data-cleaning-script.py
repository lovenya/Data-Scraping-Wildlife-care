...
file_path = r"D:\AI-ML\Data Scraping\wwf-data-scraped.xlsx"
...
df_text_concat = df.groupby('unique_id', as_index=False).agg({
    ...
    'article-post-image-src': lambda x: list(x.dropna())  # Collect images in a list
})
...
output_path = r"D:\AI-ML\Data Scraping\wwf-data-cleaned.xlsx"
