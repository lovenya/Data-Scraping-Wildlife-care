...
file_path = r"D:\AI-ML\Data-Scraping-Wildlife-care\English\deccan-herald\poaching\Data Excels (Main Data, Shortened Excel)\deccan-herald-poaching-cleaned-extracted-shortened.xlsx"
data = pd.read_excel(file_path)

# Create directories if they don't exist
text_folder = "deccan-herald-poaching-text-files"
image_folder = "deccan-herald-poaching-images"
