...
file_path = r"D:\AI-ML\Data-Scraping-Wildlife-care\English\sanctuary-nature-BLOG\Data Excels (Main Data, Shortened Excel)\sanctuary-nature-shortened.xlsx"
data = pd.read_excel(file_path)

# Create directories if they don't exist
text_folder = "sanctuary-nature-BLOG-text-files"
image_folder = "sanctuary-nature-BLOG-images"
