...
file_path = r"D:\AI-ML\Data-Scraping-Wildlife-care\English\yovizag\tiger\Data Excels (Main Data, Shortened Excel)\yovizag-tiger-cleaned.xlsx"
data = pd.read_excel(file_path)

# Create directories if they don't exist
text_folder = "yovizag-tiger-text-files"
image_folder = "yovizag-tiger-images"
