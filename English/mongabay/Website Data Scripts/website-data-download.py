...
file_path = r"D:\AI-ML\Data-Scraping-Wildlife-care\English\mongabay\Data Excels (Main Data, Shortened Excel)\mongabay-wildlife-shortened.xlsx"
data = pd.read_excel(file_path)

# Create directories if they don't exist
text_folder = "mongabay-text-files"
image_folder = "mongabay-images"
