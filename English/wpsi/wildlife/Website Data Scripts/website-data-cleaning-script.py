...
file_path = r"D:\AI-ML\Data-Scraping-Wildlife-care\English\wpsi\wildlife\Data Excels (Main Data, Shortened Excel)\wpsi.xlsx"

# Load the data from the provided Excel file
df = pd.read_excel(file_path)

# Step 1: Remove serial order number
df["unique_id"] = df["web-scraper-order"]
...
output_path = r"D:\AI-ML\Data-Scraping-Wildlife-care\English\wpsi\wildlife\Data Excels (Main Data, Shortened Excel)\wpsi-cleaned.xlsx"
