...
file_path = r"D:\AI-ML\Data-Scraping-Wildlife-care\English\telegraph-india\wildlife\Data Excels (Main Data, Shortened Excel)\telegraph-india-wildlife-shortened.xlsx"
data = pd.read_excel(file_path)

# Create directories if they don't exist
text_folder = "telegraph-india-wildlife-text-files"
image_folder = "telegraph-india-wildlife-images"
