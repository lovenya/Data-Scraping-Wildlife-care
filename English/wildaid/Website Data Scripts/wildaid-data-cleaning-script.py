...
file_path = r"D:\AI-ML\Data-Scraping-Wildlife-care\wildaid\Data Excels (Main Data, Shortened Excel)\wildaid-data.xlsx"
    ...
    if isinstance(images, list) and images:
        for i, image in enumerate(images):
            ...
            if i > 0:
                ...
                new_row["article-links"] = None
                new_row["article-links-href"] = None
...
output_path = r"D:\AI-ML\Data-Scraping-Wildlife-care\wildaid\Data Excels (Main Data, Shortened Excel)\wildlife-data-cleaned.xlsx"
