...
file_path = r"D:\AI-ML\Data-Scraping-Wildlife-care\wildaid\Data Excels (Main Data, Shortened Excel)\wildaid-data-cleaned-shortened.xlsx"
data = pd.read_excel(file_path)

# Create directories if they don't exist
text_folder = "wildaid-text-files"
image_folder = "wildaid-images"
