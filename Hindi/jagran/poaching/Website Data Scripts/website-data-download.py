...
file_path = r"D:\AI-ML\Data-Scraping-Wildlife-care\Hindi\jagran\poaching\Data Excels (Main Data, Shortened Excel)\jagran-poaching-hindi-scraper-shortened.xlsx"
data = pd.read_excel(file_path)

# Create directories if they don't exist
text_folder = "jagran-poaching-hindi-text-files"
image_folder = "jagran-poaching-hindi-images"
