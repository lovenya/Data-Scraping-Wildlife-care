...
file_path = r"D:\AI-ML\Data-Scraping-Wildlife-care\Hindi\jagran\wildlife\Data Excels (Main Data, Shortened Excel)\jagran-wildlife-hindi-scraper-shortened.xlsx"
data = pd.read_excel(file_path)

# Create directories if they don't exist
text_folder = "jagran-wildlife-hindi-text-files"
image_folder = "jagran-wildlife-hindi-images"
