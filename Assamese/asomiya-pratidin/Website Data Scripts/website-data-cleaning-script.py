...
file_path = r"D:\AI-ML\Data-Scraping-Wildlife-care\Assamese\asomiya-pratidin\Data Excels (Main Data, Shortened Excel)\asomiya-pratidin-assamese-wildlife.xlsx"
...
df_text_concat = df.groupby("unique_id", as_index=False).agg(
    {
        ...
        "article-subheading": "first",
        "article-location": "first",
        "article-date": "first",
    ...
    if isinstance(images, list) and images:
        for i, image in enumerate(images):
            ...
            if i > 0:
                ...
                new_row["article-subheading"] = None
                new_row["article-location"] = None
...
output_path = r"D:\AI-ML\Data-Scraping-Wildlife-care\Assamese\asomiya-pratidin\Data Excels (Main Data, Shortened Excel)\asomiya-pratidin-assamese-wildlife-cleaned.xlsx"
